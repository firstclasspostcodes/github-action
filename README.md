  ...
  deploy:
    ...
    steps:
      ...
      - name: 'cloudformation/triggers'
        uses: firstclasspostcodes/github-action/cloudformation/triggers@v1.3.0
        with:
      ...
      - name: 'cloudforation/package-template'
        uses: firstclasspostcodes/github-action/cloudformation/package-template@v1.3.0
        with:
      ...
      - name: 'cloudformation/deploy'
        uses: firstclasspostcodes/github-action/cloudformation/deploy@v1.3.0
        with:
      ...
      - name: 'cloudformation/run'
        id: stack
        uses: firstclasspostcodes/github-action/cloudformation/run@v1.3.0
        with:
          # Optional: Pass through a valid JSON object for required parameters.
          # 
          # Parameters can either be a string, or an object (as demonstrated below).
      ...
      - name: 'cloudformation/errors'
        if: failure()
        uses: firstclasspostcodes/github-action/cloudformation/errors@v1.3.0
        with:
      ...
      - name: 'cloudformation/read-parameters'
        id: parameters
        uses: firstclasspostcodes/github-action/cloudformation/read-parameters@v1.3.0
        with:
      ...
      - name: 'cloudformation/delete'
        uses: firstclasspostcodes/github-action/cloudformation/delete@v1.3.0
        with:

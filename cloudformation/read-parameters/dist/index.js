...
AWS.EventListeners = {
  ...
  RestXml: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(413);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
...
Object.defineProperty(apiLoader.services['ssm'], '2014-11-06', {
  get: function get() {
    ...
    model.paginators = __webpack_require__(749).pagination;
    model.waiters = __webpack_require__(897).waiters;
    return model;
  },
  enumerable: true,
  configurable: true
...
AWS.util.update(AWS, {
  ...
  Protocol: {
    ...
    RestXml: __webpack_require__(413)
  },
...
var eventMessageChunker = __webpack_require__(215).eventMessageChunker;
...
var Shape = __webpack_require__(538);
...
const { readParameters } = __webpack_require__(545);
...
const SSM = __webpack_require__(198);
...
util.createEventStream = util.stream.Readable ?
  __webpack_require__(99).createEventStream : __webpack_require__(273).createEventStream;
